...
function exerciseOne(arrayOfPeople) {
  ...
  arrayOfPeople.forEach(element => {
    ...
    newJob.textContent = element.job;
...
function exerciseThree(books) {
  ...
  books.forEach(book => {
    ...
    imageBook.src = book.src;
    imageBook.setAttribute("width", "200");
    imageBook.setAttribute("heigth", "200");


    listItem.appendChild(newBook);
    listItem.appendChild(imageBook);
    list.appendChild(listItem);
